...
void BlueMen::dmgGiven(double amount)
{
...
int BlueMen::Defense()
{
    ...
    cout << getRace() << " has " << getArmor() << " armor and rolled a " << getDice1() << " and a " << getDice2() << " and a " << getDice3() << " for a defense total of " << getdiceTotal() + getArmor() << endl;
    return 0;
}
